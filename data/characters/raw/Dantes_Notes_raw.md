## Dante's Notes
**Dante's Notes** (*Hangul*: 단테의 노트) are a feature of the Theater first added to the game with the May 11th, 2023 update. It was originally described as "records and scribbles on various points of the City's setting as observed and written from [Dante's] perspective."[1]
*
## Contents
1 Overview
2 Entries
2.1 The City
2.1.1 Districts
2.1.2 Limbus Company
2.1.2.1 Mephistopheles
2.1.2.2 Luxcavation Dungeons
2.1.2.3 Mirror Dungeons
2.1.2.4 Refraction Railway Line 1
2.1.2.5 Refraction Railway Line 2
2.1.2.6 Refraction Railway Line 3
2.1.2.7 Refraction Railway Line 4
2.1.2.8 Refraction Railway Line 5
2.1.2.9 Refraction Railways
2.1.2.10 The Backdoor
2.1.2.11 PDA Device
2.1.2.12 Sinners
2.1.2.13 The Golden Boughs
2.1.2.14 The LCA
2.1.2.15 The LCB
2.1.2.16 The LCC
2.1.2.17 The LCD
...
2.1.3.1 A Corp.
2.1.3.2 H Corp.
2.1.3.3 Heishou Packs
2.1.3.4 K Corp.
2.1.3.5 L Corp.
2.1.3.6 Lobotomy Corporation
2.1.3.7 M Corp.
2.1.3.8 N Corp.
2.1.3.9 P Corp.
2.1.3.10 R Corp.
...
2.1.4.2 Color Fixer
2.1.4.3 Offices
2.1.4.4 The Associations
2.1.4.5 Cinq Association
2.1.4.6 Devyat' Association
2.1.4.7 Dieci Association
2.1.4.8 Liu Association
2.1.4.9 Seven Association
2.1.4.10 Shi Association
2.1.4.11 Zwei Association
2.1.4.12 Workshops
2.1.5 Syndicates
2.1.5.1 The Blade Lineage
2.1.5.2 The Fingers
2.1.5.3 The House of Spiders
2.1.5.4 The Index
2.1.5.5 The Middle
2.1.5.6 The Pinky
2.1.5.7 The Ring
2.1.5.8 The Thumb
2.1.5.9 The Kurokumo Clan
2.1.5.10 Yurodiviye
2.1.6 The Backstreets
2.1.6.1 Night in the Backstreets
2.1.6.2 Sweepers
2.1.7 The City's Technology
2.1.7.1 Anamnaworm
2.1.7.2 Combat Capability
2.1.7.3 Concept Incinerator
2.1.7.4 Dimensional Container
2.1.7.5 E.G.O
2.1.7.6 Enkephalin
2.1.7.7 Identities
2.1.7.8 Identity Uptying
2.1.7.9 Memory Wipe Procedure
2.1.7.10 Mirror Worlds
2.1.7.11 Monolith
2.1.7.12 Shin (心)
2.1.7.13 Singularities
2.1.7.14 Thread
2.1.7.15 Threadspinning
2.1.7.16 Upgrading Identities
2.1.8 The Outskirts
2.1.9 The Great Lake
2.1.10 Uncategorized
2.1.10.1 Bloodfiends
2.1.10.2 Monsters
2.1.10.3 The Library
2.1.10.4 The Sign
2.1.10.5 Walpurgis Night
2.1.11 Abnormalities
2.1.11.1 Risk Levels
2.1.12 Distortions
2.1.12.1 Peccatula
2.1.12.2 Stage 2 Pecctatula
2.1.12.3 Stage 3 Pecctatula
3 Story
4 Trivia
5 References
6 Navigation
## Overview
Dante's Notes are updated once a day at 6AM KST (with the daily reset), and, prior to Season 6, were known to be added throughout the two weeks leading up to a new Season. The first three releases of Dante's Notes received story content in conjunction with the first entry of the Season, but this trend was discontinued after Season 3. Additionally, Season 6 was initially skipped, with its entries eventually added alongside the LCB Regular Check-up BokGak during early Season 7. Afterwards, Season 7's notes were added with the release of new story content.
Thus far, Dante's Notes has run from:
May 11th, 2023 - May 31st, 2023 (Season 1)
October 19th, 2023 - November 1st, 2023 (Season 2)
March 14th, 2024 - March 28th, 2024 (Season 3)
September 26th, 2024 - October 10th, 2024 (Season 4)
April 30th, 2025 - May 15th, 2025 (Season 5)
March 19th, 2026 - April 2nd, 2026 (Season 7)
April 16th, 2026 - April 22nd, 2026 (Season 7)
## Entries
"Wait!"
The following section contains spoilers. Manager, please be cautious!~*
### The City
*I’m not sure where to even start.**I guess it’s only natural, given that I can’t tell how much I forgot to begin with.Maybe I’ll start by making notes whenever I run into things I don’t remember.*
#### Districts
Record #1 - 984.12.11
- It seems that Fixers in each cardinal direction of the City differ in outfits and practices.
...
Record #2 - 984.12.29
- Apparently, Associations in different cardinal regions—West, East, South, and North—each have different uniforms. It also seemed that Association Fixers working in the same region as their headquarters were considered to be stronger or higher-ranking than Association Fixers in other regions. And, sometimes, transfers between regions happened as a form of promotion as well.
...
- It’s a name that should be the most closely related to me… but it’s also the hardest to describe for me.**Cause… they won’t tell me anything. I didn’t join the company of my own accord.At first, I thought the company’s initiative was to find and retrieve the Golden Boughs, but that only seems to be *our* department’s goal, not the entire company’s.
Record #2 - 984.4.21
...
Mephistopheles [Show/Hide Additional Entries]**
Record #1 - 984.5.17
...
- Apparently, it’s powered by an engine that Faust designed.**Everything special about Mephistopheles comes from its engine. Not only does it power the vehicle so that the bus can drive us to places, but it also lets us extract Identities from other worlds. We can also enter breakrooms or training rooms via its Backdoor, all thanks to the engine.
...
Record #2 - 984.5.29
- Huh… The bus really transformed into a boat.I guess this is what the ‘additional functions’ meant…Further modifications and performance upgrades were made possible by using both the resonance tuning fork and Mephistopheles’ engine. (That Mika person was in a constant state of astonishment, now that I think about it.)Heck, it’s bigger on the inside than it is outside. I won’t be surprised if all kinds of fantastical functions get added to it in the future.
...
Mirror Dungeons
Record #1 - 984.5.18
- They're 'dungeons’ we can access via the Backdoor.The corridor that leads to the Mirror Dungeon is made of cold, heavy metal. It inspires a different kind of anxiety from our usual wooden doors and corridors.
...
- I recall that we’ve interacted with some of these Abnormalities before in the Mirror Dungeons. Faust says that our interaction with them in the Mirror Dungeons were through some kinds of… spaces. Their mental spaces and worlds, that is.I guess the railway happened to stop by one of those worlds?
...
Record #1 - 984.12.10
- A blue-ish station themed after a banquet hall.
...
Record #1 - 984.12.28
- A railway of purple light. It was labeled 'Line 5'.
...
Record #2 - 984.5.20
- Faust tells me that they appear to be like… 'simulations, or a series of locations generated in order to improve our capabilities akin to the functions of Mirror Dungeons or the Luxcavation Dungeons from the Backdoor'.That makes sense. We encountered enemies like Kromer in there, but all they did was fight us. Maybe they’re also just simulations, after all.
...
- I can see that the corridor past the Backdoor extends beyond the area we use, but somebody put a sign there warning us not to trespass.We almost had a huge accident when Heathcliff tried to go past the threshold in spite of the warnings. Something tells me that there are dangerous things or territories in the deeper parts of the corridor.Heathcliff’s panicked face is still fresh in my memory… And Faust’s uncharacteristic urgency, too.
...
PDA Device
Record #1 - 984.12.08
- It’s my company-issued device. I write journal entries on it like I’m doing now, and I sometimes communicate with the Sinners’ Identities, too. There probably was some of that Mirror technology involved in the making of this device.
...
- I asked Vergilius about the term, but he didn’t give me a clear answer.Him and his “You’ll see in due time…” He’s shut down several questions with remarks like that.…Looks like I have no other option here, I’ve gotta write down whatever I learn.
Record #2 - 984.4.23
...
Record #2 - 984.5.3
- The Sinners seem to experience a kind of dizziness when they get near this thing.I hear it’s called “resonating”, and it might be similar to how I get headaches.
- Once we return with a Bough, Vergilius calls people from some other department to take care of it.When I asked him about this, he just said it’s “submitted to headquarters”.
Record #3 - 984.12.09
- I still have no clue how these Golden Bough work. But if it really can grant people’s wishes… it’s got to be something incredible.
...
Record #4 - 985.2.22
- In that mansion, Faust told me to "simply do as you will—as one seeks the stars in the night sky." I still don't fully understand the whats and hows, but by resonatiing with the Golden Bough, I've gained access to several unusual abilities.
- I can slow down time, support the Sinners when they use E.G.O, and supress the strength of our enemies. And now, I can even summon the Sinners' Identities from afar. Faust insists that it's not a "summoning magic," though...
- Hohenheim says the Golden Boughs we've gathered are being grafted together into a single sapling. A single Bough alone can exercise immense power—what would happen if they're all combined? And what exactly do the higher-ups plan to do with it?
The LCA
Record #1 - 984.11.04
...
Record #1 - 984.4.20
- Limbus Company Bus.
- Its name comes from the fact we’re on a bus.Feels like they didn’t put a lot of thought into the name, but the other departments aren’t far ahead in terms of sophistication.
- The team includes people like me and the ones called… Sinners(?) who’re sitting back behind. (Still not used to this word.)The purpose is to retrieve things called “Golden Boughs” from the underground facilities of “Lobotomy” or whatever the “L” Corp. stood for.I dunno what Golden Boughs are, but from the sound of it: some physical objects shaped like tree branches. (Will make a separate note when I learn more.)
Record #2 - 984.4.21
- Seems retrieving Golden Boughs isn’t the only job.We’re sent to deal with any task on the way to the company’s objective that needs capabilities unique to me or the Sinners.
- I’m starting to wonder how this company came to be, and why it had to be me and the Sinners to do all this, but Faust won’t tell me.She says the security level is too low for me to access the information, but she seems to know something more.Why does a “Sinner” know more about the company when I’m the “Executive Manager”…?
The LCC
Record #1 - 984.4.20
- Limbus Company Clearance.
- Its name comes from the fact they “clear” things up and out.It was formed to aid the bus team’s work.Unlike the Sinners, I can’t revive them with my powers, which explains the care put into their gear and equipment.
- The department seems to be split into two teams. The Before Team (LCCB) handles scouting and preparation work, while the After Team (LCCA) handles gathering and cleaning up what we’ve done.I haven’t met them yet, but the teams seem to be divided into several sections if Vergilius’s phone calls are anything to go by.
...
Record #2 - 985.2.24
- I met Moses, LCD's On-site Investigative Reasoning Team Leader.
- Unlike me, who can only tell whether an entity is a Distortion or not through a vauge sense of frequency waves, so to speak... She seems to have the ability to somehow directly perceive and witness potential Distortions within other people. It's really a mysterious power, I'll give her that.
- Aeng-du and Bamboo-hatted Kim have joined the LCD, too. Meaning we'll be crossing paths with them more often than we think.
The LCE
Record #1 - 984.12.21
- Limbus Company Enkephalin
- They're Limbus Company's research and energy generation department.
- Under Chief Researcher Hohenheim, this department conducts various studies and research.
- They study Abnormalities, Distortions, and even Peccatula—isolating and studying them. Its interiors are designed somewhat similarly to those of the former L Corp., Lobotomy Corporation.
- The employees were all wearing E.G.O gears extracted from Abnormalities. According to them, the gear is distinguished from Lobotomy Corporation's E.G.O gear because it exhibits more of each source Abnormalities' idiosyncracies.
...
A Corp.
Record #1 - 985.2.4
- They're "The Head." Located in... Well, I'd assume they're located in District 1.
- If anyone breaks a Taboo of the City—whenever, wherever—The Head will swoop in to punish the perpetrator.
- Normally, such infractions invite only the Claws, which are like enforcers from C Corp., but a Taboo violation of a sufficuent scale might even end up summoning these beings called "Arbiters."
- I saw them in Hong Lu's memories of the Kong Family massacre. The moment the Kong Family "violated" a Taboo, the Head swooped in and destroyed all evidence that the transgression had ever occured.
H Corp. **[Show/Hide Additional Entries]**
Record #1 - 985.1.1
- Hongyuan Bioengineering Group. Their Nest is located in District 8.
...
Record #2 - 985.2.6
- Jia Xichun ultimately won the Family Hierarch War and became H Corp.'s Hierarch, but has a slight stumble at the begining of her reign due to Jia Yuanchun's machincations.
- Thankfully, as Jia Xichun managed to win the faith of the Four Families and the board of directors, the motion of no confidence Jia Yuanchun put forth failed to garner enough votes. Jia Xichun said she wishes to make Hongyuan a place where no one needs to live in fear, a place where one does not need to project fear... Perhaps H Corp. can finally leave behind its terrible past and change for the better?.
- ...Speaking of which, are we ever going to leave this place? They've already held two separate farewell banquets for us, and after a few more excursions, I might need a third hand to count the number of times we'd bid our final good-byes to those guards at the gate. We're... we're not settling down here or anything, are we?
Heishou Packs
Record #1 - 985.1.2
- They're something of a private army for various forces of Hongyuan.
...
Record #2 - 985.2.3
- There seems to be these mysterious figures known only as the Heishou-Xianren, each managing a Pack and the corresponding Heishou Bolu. I wonder how they're distinguished from the Xianren of the Tiekan Temple?
- The right to "own" the Heishou Packs is called a "leash," and I think it's a kind of commodity that can be traded between people. Didn't get the chance to see for myself what those "leashes" look like, though.
- There seems to be a way to "un-leash" a Heishou and free them from service. But from what information I could gather from the Heishou Pack Identities, such generosity rarely ever happens because the price of freeing even a single Heishou is far too costly
K Corp.
Record #1 - 984.4.22
- Located in District 11’s Nest.
- As evidenced by our nightmarish battle at the checkpoint… K Corp’s Singularity seems to give the user the capability to continuously heal—or regenerate, rather—their body.**Faust called it “Helapoiesis”, but it seems to be more commonly referred to as HP “bullets” or “ampules” by regular denizens of the City.Thanks to that, all the Sinners died and I almost fainted bearing 12 people’s worth of pain at once…But, those HP ampules did also help restore my melted lower half to perfectly good health.
...
- They explained that HP ampules were actually infinitesimally tiny nanobots helping regenerate the body. Apparently, they were so small that a collection of them just happened to look like some green fluid.But none of that was true. They weren’t anything even remotely close to nanobots. The ampules were just filled with some green fluid.
...
L Corp. [Show/Hide Additional Entries]**
Record #1 - 984.4.23
- Full Name: Lobotomy Corporation.
- Its Nest was in District 12. A fallen Wing, its spot currently vacant.**It was apparently the epicenter of a City-wide event called the *White Nights and Dark Days*, which everyone seems to know. (Except for me, or would that be the amnesia…?)The facilities we search through for the Golden Boughs all once belonged to this now-defunct L Corp.
...
- Then, one day, a fierce ray of light shot out of the headquarters and the company went under just like that.I even heard that after the company was gone, some… *tower thing* appeared in its place, and then disappeared sometime after. The Wing’s spot is still vacant as I write this, which apparently has the whole District in chaos.
...
M Corp.
Record #1 - 984.12.24
- Their Nest is located in District 13.
- They seem to have control over a Singularity called the ‘Moonlight Stones’. They're said to allow people to focus solely on a singular subject or eliminate all distracting thoughts… And given this, they have this facility called ‘Abyss Trauma Correctional Facility’, maybe they specialize in psychological healthcare or relaxation businesses.
- Hey, maybe we should buy these Moonlight Stones for the Sinners to prevent E.G.O Corrosion or help calm them down and relax when their ‘turn’ comes up?
...
- Having spoken with Meursault, apparently there are *two* factions under the names of ‘Nail’ and ‘Hammer’.According to him, the armor-clad “Inquisitors” we faced weren’t nearly as prevalent when he worked for the Wing, and they weren’t the majority faction during his time there.
...
Record #2 - 984.4.24
- Not sure what its main business is, but some Sinners seem to know a couple things about the Wing.…If only they’d speak to me at all about it.
P Corp.
Record #1 - 984.12.20
- Their Nest is located in District 16.
...
Record #2 - 984.12.25
- Their motto has something to do with creating a very safe home, and their Singularity can either expand or warp the space itself.
- I was told that structures built using P Corp.'s Singularity are all very… *elastic*. That turned out to be surprisingly literal, as when La Manchaland began to manifest, I could see the buildings touching La Manchaland bending outward like rubber. They said that it's completely safe inside even if the building's exterior bends and twists like that, but… I can't imagine how that could be true.
...
- With what I’ve heard about R Corp. from its related Sinners, it seemed a little different from the other Wings I know so far.While most Wings provide many a convenience by utilizing their Singularities to improve people’s quality of life, R Corp. mainly deals in armed services like mercenaries.
- R Corp’s power as a Wing comes from the quality of its military services.Outis added that as important as a troop’s size is, much of its strength in battle will come from field experience and mental fortitude.In that sense, she says R Corp’s combatants (soldiers? employees?) are like killing machines with undaunted spirits on top of being in great health.Gregor said it’s common for ordinary soldiers to lose their will to fight and then flee the battlefield or fall into panic, and those who don’t are the exceptions.I wonder if R Corp. runs wargames and simulations or something.
Record #2 - 984.5.9
...
Record #2 - 984.12.12
- Well, I do understand that I accidentally manipulated a lot of time. But I asked Yi Sang, out of pure curiosity, how we ended up saddled with more than ten-billion Ahn of Time Tax.
...
The Wings [Show/Hide Additional Entries]**
Record #1 - 984.4.21
- Companies with the most advanced and influential technology in their Districts, practically ruling over them.**Supposedly they’re corporate entities, but the more I hear about the Wings, the more they sound like governing bodies.(Come to think of it, Limbus Company doesn’t seem to fit the conventional idea of a company, either. We’re on a bus all the time, for one.)
...
The Smoke War
Record #1 - 985.2.20
- A Wing War that took place with the Old L Corp. as one of the main players—before the rise of Lobotomy Corporation.
- The horrors we experienced through Gregor's Fathoms were apparently only a tiny glimpse of the unspeakable things that actually happened during the War. Both Gregor and Outis seem extremely unwilling to talk about what exactly they witnessed back then.
- I've heard that just a record of fighting in the War can lead to exclusion from many benifits in the City—Nest residence rights, for example. And this applies not only to the losing side but to the ones who joined the victors as well... but for what reason?
- The Old G Corp., which fell apart following the War, reportedly possessed three decisive weapons that fought on the front lines—the Maggot Prince, the Moth Princess, and the Lord of Flies. Just hearing the name makes me... well, not want to encounter anything of the sort.
- Gregor metamorphosed into the Roach Emperor, a Wing's decisive weapon whose rumors are only told in urban legends. Even Vergilius found him a difficult opponent to face. I wonder if the other entities—"decisive weapons"—were that strong, too. And of course, just what kind of insane force did the winning Wings have at their disposal to emerge as victors?
Record #2 - 985.2.21
- According to Sinclair from the future—or, perhaps, according to one of Sinclair's future possibilities—another war seems to have broken out where he came from.
- The Second Smoke War. If such a future ever becomes reality, what would it mean for us all?
U Corp.
Record #1 - 984.5.26
...
- I haven’t visited their place yet, but I learned a thing or two about it from conversations with the identities from this Wing.W Corp. seems to be operating a transit service advertised as “WARP Trains” that take passengers from platform to platform in mere seconds.Tickets for WARP trains are apparently pretty costly, and I’m told the first-class ones are plain ridiculous.
- …Shouldn’t you just cut costs and drive at that point?
Record #2 - 984.5.8
- Writing down additional details I’ve heard.
- While cars can take you anywhere, WARP trains are preferred because travel by car can get incredibly complicated.Makes sense, considering the procedures we went through just to get into K Corp’s Nest.
- Speaking more, it seems the bigger problem is the roads are made inefficiently.They’re so twisted and convoluted that it takes an unreasonable amount of time to travel between Backstreets areas by car.
- Even if the linear distance is short, the road to the destination will be labyrinthine.Purportedly there are wide, open roads called highways connecting the Nests, but that comes with a set of conditions and costs as well.
Record #3 - 984.5.9
- Learned a shocking fact while talking with Sinners done up in W Corp’s identities.Though they didn’t tell me directly… it seems that the trips on WARP trains which take no more than a few minutes from an outsider’s perspective make their passengers perceive a terribly long amount of time, dissolving their sanity and deforming them beyond recognition once the ride is finally over.Then, it’s the job of the cleanup agents to physically sort out the mess every time.…Thank goodness we have a bus.
- This is all speculation based on conversations with the identities, so I’m planning to keep this information to myself.
Record #4 - 984.12.13
- After I found myself plenty of W Corp. employee Identities, and learned quite a bit about WARP trains from them, I felt comfortable enough to share that information with the Sinners. Which turned out to have been a good move in hindsight. It would’ve been a disaster to have to explain WARP trains to them at that moment.
...
Record #1 - 985.3.1
- Wayfarer Company.
- With the recent series of incidents involving Warp Corporation, this new business entity arose to supplant its place as the new W Corp... In other words, a Wing hopeful.
- Faust explained that their core technology, called "Portals," resembles the properties of Backdoors. From my recent, unintended use of them (which has been quite frequent, truth be told), I find them incredibly convenient. The way Portals work, one door leads to another, without requiring a connection to Corridors as Backdoors do.
- I heard that Portals still have some instabilities that may cause side effects, but I don't think I've experienced or witnissed any so far. Considering what Faust and Outis have mentioned before, it might simply be because I've only been using expensive portals... but there could be another reason for it.
- Currently, it seems they are working with Limbus Company to establish forward bases throughout the Corridors at the House of Spiders and look into the Backdoors within them.
- We had the chance to work with Team Leader Alan from here. He has a bit of that corporate attitude, but he's generallt amiable and seems favorably disposed towards us. Though... after seeing him straight-up socking Kira out of nowhere, not to mention that unsettling, subtle coldness hiding between his words... Can't blame myself for not wanting to see him as a decent person at the end of the day.
- Alan said Wayfarer's primary services include pathfinding, path security and path maintenence. It doesn't seem like the "paths" he mentioned refer to Corridors, but I doubt I could've gotten a more detailed explanation, considering it's a closely guarded corporate technology.
X Corp.
Record #1 - 984.12.23
- Their Nest is located in District 24… or so I've been told.
...
Butlers
Record #1 - 984.12.07
- Don Quixote explained that they are Fixers signed onto long-term contracts, bound by individuals, families, or estates.
...
Color Fixer
Record #1 - 985.2.23
- This is "every Fixer's dream" and the reason they live for, says Don Quixote. "Individuals who have attained the complete perfection of liberty and freedom as Fixers"... is what she so enthusiastically proclaimed about these people. Though, thinking back on the Fixers we've met and the Fixer Identities we've used so far... I can't help but feel that Don Quixote's statement contains a bit of her usual hyperbole.
- Even Don Quixote doesn't seem all too sure why colors are used to name them in the first place. Some of the speculations attributed are that colors are easy to remember, and that colors represent the unique way of life each Color Fixer pursues.
- The Red Gaze. The Indigo Elder. The Yellow Harpoon... we've fought alongside three Color Fixers already. Perhaps we'll come to encounter others in the future, but I'd *definitely* prefer not to meet them as enemies.
Offices
Record #1 - 984.4.28
...
The Associations **[Show/Hide Additional Entries]**
Record #1 - 984.4.27
- Seems to refer to the large organizations that manage Fixers.
- Each Association appears to have a specific field it specializes in to account for how free and open a Fixer’s line of work can usually be.**There’s a pretty wide variety… I’ve seen a few Associations through the identities of Sinners and their mirror worlds.
...
- All I know about this Association comes from what I heard from the Seven Association identities, so I couldn’t learn much…Since the Association doesn’t get requests too often, it seems to be in charge of holding joint conferences and events with other Associations as well.
Record #2 - 984.12.30
- When declaring duels, the eastern Branch of the Cinq Association, instead of doing so by tossing their glove, do so by announcing their affiliation and name.
...
- Apparently, the green flame of the Virescent Pyrojades has the power to burn *only* the object that the user wants it to. … Honestly? That sounds like a Singularity-tier tech to me.
Devyat' Association
Record #1 - 984.5.27
...
- Yi Sang told me that, “While the City may appear minuscule in the bird’s eye view that the map avails one, an approach that contemplates its surface area and not what a single surface of it shows a world vastly different. The City is tight with brimming buildings in both heaven and earth, their labyrinthine construction and the Singularities paint a picture hidden afore a screen…”. I wasn’t sure what he was talking about, so I just nodded along.
Record #2 - 984.12.19
- Apparently, they make deliveries using dimensional bags equipped with an AI ‘Poludnitsa’, called ‘Courier Trunks.’ To be more exact, it seems like the Association assigns the type of Poludnitsa most appropriate for the contract and the path each Devyat’ Fixer.
...
Record #2 - 984.4.29
- According to Don Quixote (“Discerning the two may yet be a task too daunting for novice aficionados!”, she also added), while the Cinq Association covers one-on-one situations like duels, the Liu Association handles engagements between multiple combatants. Come to think of it, most of those identities did seem to value cooperation and coordination over individual action.They also looked rather carefree, too…
...
- When I asked why they use fire-starting weaponry, they gave me varying answers like “harmony” or “flow”…But those honestly felt like roundabout remarks. In my opinion, it’s probably because fire is effective as a means to strike foes around the target. Flames can spread, after all.
Seven Association
Record #1 - 984.5.27
...
- Should note that it doesn’t exactly mean they’re the only Fixers who ever assassination jobs. To start, requesting an Associate Fixer is gonna cost a fortune…Plus, the demand for assassination is awfully high in the City, so even unknown Offices on obscure streets seem to get those requests pretty often.
Zwei Association
Record #1 - 984.12.18
- They seem to specialize in protecting and upholding the public peace of the zone requested by their clients.
...
- Guessing from conversations with the Sinners who wore such Identities, they don’t seem to act or move in groups much despite belonging to a Syndicate.**To be more precise… they do have temporary company from time to time, but there’s no strict subgroups or pecking order.
- …It’s unfortunate that half of their answers were taking the piss, so I am unable to write proper answers here.
The Fingers [Show/Hide Additional Entries]**
Record #1 - 984.12.31
- This must be referring to the five particularly significant Syndicates of the Backstreets.
...
Record #1 - 985.2.18
- The House of Spiders is said to have been formed by the Five Fingers with a common goal. The Fingers—at least those I've come across—hardly seem like the sort that could ever see eye to eye...**Learning that they could actually come together and cooperate was a bit suprising. Makes me wonder if they've ever teamed up for anything else behind the scenes.
- The organization is made up of five "Nursefathers," chosen from each Finger, and five "Apprentices" brought in to fill the gap after Ryōshū left.
- They came up with grand terms for what they had gathered to create—"the strongest killer," "the blade that cuts through all"... but these were realy just another way to dress up the true purpose of their organization: to nurture and train someone with an aptitude to wield the Arayashiki and turn them into something akin to a living Concept Incinerator. That someone turned out to be Ryōshū, our Sinner #4... and while most of its members didn't survive to see it, the House *did* accomplish their objective, in the end.
Record #2 - 985.2.25
- Outis suggested that the "Muga," which the House tried to turn Ryōshū into, might be a kind of Concept Incinerator, too... but Faust flatly rejected the idea. The principle and nature of the Muga are entirely different from how a Concept Incinerator might work, she said.
- According to Hohenheim, a technology capable of burning away the very concept of an object or a being simply by throwing the thing you want erased into it—that alone would amount to a Singularity.
- Yi Sang added that it is because all that is tethered to what has been placed within the Muga is severed away, and that which is severed from all becomes what exists yet has been disconnected from the world, thereby its state assuming nonexistance for the universe... I might not have understood that explanation before, but now, I think... I can at least piece together a little something.
- Rien, the Index Nursefather, left a warning that Ryōshū will be the most important subject of discussion in the next Finger Bow-Bell. I have no idea how exactly a Finger Bow-Bell takes place, or how dangerous it might be... but one thing is for sure: it's coming, and I'll need to brace myself for the troubles it'll bring.
The Index
Record #1 - 985.2.19
- A Finger known for its unwavering faith in the Prescripts.
- Their members follow these so-called "Prescripts" without question. I wonder who sends out the messages...
- The Index Nursefather and his Apprentice we encountered recieved their Prescripts on a device, but it seems the other members of The Index recieve theirs on paper slips delivered by Messengers—which raises a question: can Prescripts be delivered by other methods as well? Emails... or a phone call, maybe?
- From what I've seen and heard so far, there seems to be positions within The Index called "Proselytes," "Proxies," and "Messengers"... but information on their hierarchy and exact roles is still unknown.
The Middle
Record #1 - 985.1.02
- As one of the five Fingers, they prioritize loyalty.
...
The Pinky
Record #1 - 985.2.1
- The Pinky is one of the five Fingers that follows the Virtue of Humanity (仁), which I'm still a bit unsure as to what it means. The point is, they're a bit more cryptic than the other Fingers when it comes to what they pursue.
- Instead of going around in their uniforms and advertising their true alignments like the other Fingers, they lurk anonymously in other organizations.
- There seems to be some condition and means of summoning the Pinkies all together, but when they're not summoned, they just lead their own lives as though they aren't even a part of this Finger. I don't know, can we even call them a real organized crime Syndicate?
The Ring
Record #1 - 984.12.31
- The Ring, one of the five Fingers, values art and knowledge.
...
Record #2 - 985.2.28
- While we were helping Hohenheim with the Backdoor investigation, we accidentally stumbled into one of the Ring's galleries—that of the Fauvists, to be specific. If we're counting the Ring Nursefather Callisto's Corridor a "gallery," then I guess this is the second gallery of the Ring we'd seen.
- Kira seemed to be incredibly impressed by some of the taxidermied animals in there, and... I must admit, some of those were pretty cool, even for me. As for the rest... Well. I don't feel that they necessarily need to be described here.
- Each school of the Ring seems to have pretty distinct ideas on beauty or artistic philosophy. Ryōshū explained that there were minor schisms even among followers of Fauvism.
- Rufo, that Fauvist Docent, claimed that Ryōshū is taking the steps towards founding her own movement.
- So... going by how the other Schools are named, will it be something like Abbreviatists? SANGRIAists? Shortenists...? Ooh, maybe Ryōshū'll combine and acronymize it all into A.S.S.ists?... Wait, that doesn't really work...
Record #3 - 985.2.28
- Curse my curiosity, because it actually compelled me to pay Ryōshū a visit and ask her is she was planning on naming her school, what it was going to be called, and various other questions that seemed to annoy her. Needless to say, I was kicked out rather unceremoniously mid-question.
- I don't know how mant Schools of art and sects there are in the Ring, but... after hearing Ryōshū's philosophy on aesthetics and art, Rufo, a Docent of the Fauvists, claimed they would cultivate her until she could establish her own movement.
- If, one day, Ryōshū finally completes her own movement... will the Ring acknowledge her as a Maestro? Hm. I wonder if that means members of Ryōshū's School would speak in acronyms, just like she does...
The Thumb
Record #1 - 985.1.31
- The Thumb, one of the five Fingers, is utterly obsessed with the concept of propriety.
I've seen them popping people's arms out and blasting their jaws off just for questioning a superior. Though I've only met The Thumb members from the eastern branch, the Sinners tell me that they generally play by similar rules regardless of where they're based.
- "Rank" or "Class," is something they're all really touchy about, which probably explains all those rediculously detailed rules on the definitions, circumstances, types, and so on and so forth surrounding them.
- According to those Soldato... Secando? Terzo? Anyways, according to those Thumb Soldiers we ran into in Daguanyuan, we apparently deserve to lose our jaws simply for invoking a Capo Quarto's—Lei Heng's—name without deference.
- Hmm, I am the *Manager* of LCB... I wonder where I rank in their scale? Darn, I should've asked them when I had the chance...
The Kurokumo Clan
Record #1 - 984.4.25
...
Yurodiviye
Record #1 - 984.12.20
- A Syndicate founded by Sonya. Rodya once told me that they used to help the downtrodden of the Backstreets, but eventually devolved into armchair revolutionaries who did nothing but sit around talking about how they’re going to change the city.
...
[Show/Hide Additional Entries]**
Record #1 - 984.4.23
- Areas of a District not included in the Nest, outside of the Wing’s domain.**The residents are mostly people who can’t afford to live in the Nest.
- Each area is stacked with restaurants, local businesses, living quarters, schools, academies, and a variety of other facilities.As the name suggests, though, the roads tend to be twisted and intertwined, and there’s a constant air of dampness wherever you go.Fun thing I’ve noticed is that the boundaries between the Backstreets and the Nests were clearly drawn in every District I’ve visited. (Though I’ve only been to like, three of them).
Night in the Backstreets
Record #1 - 985.1.03
- Every 3:13 in the morning, the Sweepers emerge for eighty minutes to clean up the Backstreets of the City.
...
Sweepers
Record #1 - 985.1.03
- They're… people, maybe? Anyways, they appear during the Night in the Backstreets.
...
Anamnaworm
Record #1 - 985.2.2
- A bug that, when inserted into the human body, will share with its host the memories of the person that became its core.
- Immediately after insertion via the ear, the Anamnaworm will rapidly assimilate into the host, granting them all the memories and knowledge of the source individual used to make it. Convenient, but each Anamnaworm comes with the caveat that it cannot be removed by any other means than the conditions prescribed at its creation.
- Traditionally, all H Corp. Hierarchs were supposed to accept the "Xianhuang Worm," an Anamnaworm created from the founding Hierarch, into their bodies, but we managed to make it to the Tiekan Temple in time to prevent it from assimilating into Jia Xichun.
- In the chaotic aftermath that followed, the New League of Nine Littérateurs snatched the Xianhuang Worm away. Wei told me that, though the knowledge that once resided in the worm may be significant, the sheer time that has passed since its extraction from the previous host's body must have eroded much of it.
Combat Capability
Record #1 - 984.11.13
...
Concept Incinerator
Record #1 - 985.1.30
- A Singularity of a Wing capable of permanently erasing or destroying technologies.
- Its potency and scope of effect depend on the price paid, but a reasonably powerful Concept Incinerator can erase every document related to the incinerated technology, photographs, and even memories—leaving behind nothing or, if something somwhow does survive, a smudge and nothing more. Does the *Concept* Incinerator delete a concept like it never even exsisted, or does it just "smudge" our perception of it?
- Faust elaborated with an example—deleting the general concept of, say, a "clock," requires everything even tangentially related to clocks getting chucked into the concept incinerator, but deleting only a specific model of a clock is as easy as tossing its blueprint in. In other words, a smaller scope equals less incineratrion equals cheaper erasure.
Dimensional Container
Record #1 - 984.12.14
- The bags that Butlers carry are called ‘dimensional cases’, or dimensional attache cases. It seems pretty convenient, being able to store things greater than its external appearance may suggest. Maybe it’s kinda like the Backdoor of Mephistopheles.
...
Record #3 - 984.5.5
- However, if you don’t stop at just being convinced and get deeply engrossed in that other sense of self, you’ll be taken over by what’s carrying it.**That killed the Sinners a good few times…And hurt me like hell.
Record #4 - 985.2.5
- E.G.O Gears extracted by the LCE or N Corp. both have traits that distinguish them from Lobotomy Corporation's E.G.O.
- LCE E.G.O gears use "Attunement Boost" to surge the source Abnormalitiy's characteristics to the forefront, and the N Corp. E.G.O gear used by Jia Huan had an extra feature that generated a shield wall of sorts to protect its user in a moment of emergency.
Enkephalin
Record #1 - 984.4.29
...
Record #2 - 984.4.25
- Although I can’t write how exactly those identities are used in full… (Feels like attempting to makes me unsure somehow.)Synchronizing the extracted identity with my LCB-PDA and the bus window allowed me to communicate with or feel it, in a way.Calling forth the image of the identity in my mind, I get a sense of understanding as if I'm talking to the Sinner like usual… And once the Sinner and I make an unspoken agreement, the identity overrides the Sinner, accompanied by the sound of glass shattering.…Can’t think of a more suitable description.
- While overlaid with an identity, the Sinner appears pretty different from usual. On top of attires and weapons, their personalities can also change pretty wildly, and sometimes make me question if they’re really the Sinners I know.Fortunately, they seem to go back to their original selves when they’re done using an identity. But, prolonged use might cause small side effects like headaches or residual traces of the identity’s personality surfacing from time to time.
Identity Uptying
Record #1 - 984.5.6
- A process of synchronizing an *Identity* with this world using the *Thread* we’ve gathered.
- It’s how one brought from a different world is tuned to the Sinner in ours. (I guess it could be likened to binding the two worlds together?)From what I can tell, a freshly extracted Identity can’t immediately transfer all of their knowledge and combat prowess to the Sinner.That’s why Thread must be used to “uptie” the Identity and make it more effective.
Record #2 - 984.5.7
- I asked if the “MAX Uptie” status, as shown on the PDA, is really the highest possible tier.I wanted to know if that meant that the Sinner virtually becomes the same as the one from another world.
- I’ve been told it’s theoretically the case.If an Identity brought from a certain point in time of the world from where it was extracted gains more experience (training their combat skills further, for example), a new possibility can occur that allows for additional stages of uptying.I guess that’s to mean Identities from certain points in time could grow stronger in terms of experience and technique.
Record #3 - 984.5.10
...
- I’ve been told that we can’t know for sure and that it doesn’t matter anyway.Limbus Company is only interested in enhancing the Sinners’ capabilities in battle, so they don’t care about what happens with the Identity or its world as we uptie them.
...
Shin (心)
Record #1 - 985.3.2
- A power that strengthens the body, manifested through emotions and the mind.
- ...said Vespa and Vergilius, but I'm having a bit of trouble understanding what it is from that explanation alone. That said, I don't think I can do a much better job of describing it. I just see Shin (心) users surrounding themselves with some kind of golden aura, and the next thing I know, they've suddenly become stronger.
- To summarize what little I understand, Shin (心) sure seems like an incredible technique that allows people to enhance the strength and durability of their bodies without spending a single coin—and all it needs is some kind of training and meditation.
- Vergilius did mention that its output varies depending on one's emotional or mental state... but, well... whatever limitations it has, I don't see why anyone would *not* use this power... Right?
- I asked Team Leader Moses from LCD, who's apparently researching this power, and she said learning and using Shin (心) isn't always the best choice. Moses refused to elaborate further—she said she could explain only once she had properly formed a workable hypothesis.
Record #2 - 985.3.2
- Apparently, Sinners are unable to use Shin (心) without overlaying themselves with Identities—not while their pact with me holds.
- I was going to ask if I could learn how to use it too, but I missed my chance because Kira asked first... But if Sinners can't use it, I suppose that would apply to me as well.
- I wonder if I could use Shin (心) before I lost my memories. Vespa said that someone who had never once reflected on their sins—like the Middle Nursefather—would be incapable of even comprehending and using such a power in the first place. Makes me wonder what kind of person I was before my head was swapped for a clock.
Record #3 - 985.3.3
- I remember Lei Heng saying that "Mang (望)" is amassing Shin (心) and converting it into a ring of light around the user's body parts or weapons... But since I don't know exactly how that's done, I can only guess that the number of rings serves as a measure of how much stronger the user becomes with it.
- According to the Sinners' experience with Mang and Shin wielders, performing attacks with Mang wrapped around makes the same motion or technique a lot faster and stronger than before. Ishmael speculated with some uncertainty that the ring of light itself probably doesn't contain some superpower, but rather acts like a kind of gateway through which power is channeled.
- Outis added that the rings might function similarly to the rails of a railgun...
- Since I don't know much about even Shin myself, I wasn't able to ask detailed questions about Mang. The most I got was Vespa complaining that each additional ring nearly doubles the mental strain...
- Come to think of it, why does Mang contain emotions like resentment, dismay and yearning? Why does Shin, the power of the heart, coalesce into Mang?
- Yi Sang said perhaps it has something to do with hopes and desires being the unseen hands that stir the heart, but I don't think that can sufficiently explain this phenomenon...
Singularities
Record #1 - 984.5.2
- Simply put, some kind of incredible technology owned by the Wings.
- I was curious how they’re different from the other technologies in the City…I guess it’s the fact that Singularities are monopolized by the Wings that own them.
Record #2 - 984.5.4
- Another thing of note is that they almost seem to be outside the realm of logic or classical physics.Faust says it’s unnecessary to bother thinking about the intricacies in my current state, but…I don’t think you can brush off flesh regrowing from a severed arm or stickers that boost your luck as things that just work that way.
...
Record #2 - 984.5.3
- In summary…It’s all sorts of possibilities woven into spindles of thread… or something like that.To be frank, I can’t really call this a summary when I just wrote down what Faust said almost word for word. I couldn’t understand what she meant exactly…It gives me a similar feeling to looking up at the *star* that appears when I wind the clock. Sorta like awe.
Threadspinning
Record #1 - 984.5.6
- Similar to uptying, this is a process of making the Sinners’ E.G.O more powerful using Thread.…Though I do wonder, why *threadspinning* and not “uptying” again?
Record #2 - 984.5.8
- Like Identities, the E.G.O used by the Sinners are possibilities drawn from the cores of certain Abnormalities for appropriate individuals.However, using E.G.O to its full potential requires weaving together a deep understanding and well-read interpretation of the Abnormality, which is why it’s called “threadspinning”, sorta like the idiom of spinning a yarn.
...
- E.G.O seems to be the manifestation of some kind of mental force.I guess it makes sense that forming thorough knowledge of the Abnormality and its E.G.O is important.
Record #3 - 984.5.10
...
- Faust says we might be able to threadspin E.G.O beyond what we’re currently capable of in the future.Similar to upgrading and uptying Identities, gathering Golden Boughs should allow us to decipher and interpret them in further detail.
Upgrading Identities
Record #1 - 984.5.7
- When a Sinner tears this *Identity Training Ticket*, certain experiences seem to flow into them (or the Identity they’re wearing).These experiences can make them even stronger than how they were in their original worlds at the time of extraction. (Well, that’s what the “relevant theories” say, according to Faust).
- I get that they become better fighters with the added experience, but how does it make them physically stronger too?
Record #2 - 984.5.8
- I got vague but somewhat sensible answers from Faust and Yi Sang.When an Identity is “upgraded” using tickets, the Identity’s “frame” itself is enhanced.
- To summarize their explanations, upgrades exclusively improve their physical traits.The improvements are made in ways that would have worked in the original worlds the Identities come from.
...
- These values seem to be related to the Golden Boughs we’re collecting. In addition, I was told that I’d be unable to withstand further upgrades for now.Does that mean it will be possible to upgrade them more at a later point?
...
- According to Ishmael, looks like the Great Lake’s chock full of treacherous natural disasters and monsters.Even if she’s right, that it might be too early for us to go to the Great Lake… It's not like we've got much say in the matter. Limbus Company ordered us to go in that direction, so we gotta.
...
The Sign
Record #1 - 985.2.26
- A crimson sign or a mark that I've seen on a few people, one of them being Sinclair.
- It appears that Sinclair's Sign has the power to summon a version of himself from a period forward in time. Faust said it was a possibility of a certain future, or something akin to an offshoot event of an offshoot world. It certainly felt distinct from having him wear an Identity from a Mirror World.
- Demian's enigmatic words were the first thing that came to my mind when Sinclair first awakened the power of his Sign—that he would return when Sinclair becomes one with beautiful stars.
- Is drawing all three strokes of his Sign... not what Demian meant by "soaring into the sky, having unshakable faith in the power of the heart"? Well, what else could it be...? It hurts my head just to think about it.
- If only others could see the Signs too... I would've asked them for their input. Hmm, that reminds me. Didn't Sonya say something to Rodya about her not having the Sign or being unable to see them?
- Other than myself, the Sinners are the only other people in the world who were there for that conversation, and it's clearly not a good idea to bring this up to Rodya, so... Hmm, who should I ask?
Record #2 - 985.2.27
- Meursault remembered that conversation. Well, of course he did.
- Anyway, I finally found the information I needed. What Sonya had said to Rodya on that day was that she didn't have what it takes to lead.
- It makes me wonder if that condition goes both ways—does having "what it takes to lead" allow one to see the Sign? ... Well, I decided to table that question until the LCE's research could make some progress, since it seemed that they were having trouble making any meaningful discoveries concerning the Sign.
- We sort of have a working theory at this moment, that the Sign may be of the same or similar origin as Singularities and Relics, but... given that I know precious little about those two subjects, this seems to be a case of questions begetting questions.
Walpurgis Night
Record #1 - 984.5.24
...
- So far, the ones I’ve encountered (for now, anyway) usually had an appearance unlike any human or animal and possessed extraordinary powers…**They’re beings you’d only expect to see in abnormal fantasies, both in terms of what they look like and what they can do.
Record #2 - 984.5.1
...
Record #3 - 984.5.5
- The old L Corp. used to classify Abnormalities into five levels.Yuri told us that L Corp. graded them based on their energy production efficiency.Limbus Company seems to use the same levels to categorize them.
Risk Levels
Record #1 - 984.11.02
...
Record #3 - 984.12.22
- We learned more about the new Classification codes and Risk Levels.
...
Record #3 - 984.12.16
- The unique powers of each Distortion are somewhat like Singularities… or sometimes, even surpass them. Even the T Corp. Chief Executive Director said that he saw a new possibility through the Distortion called the Time Ripper. What’s their true potential, I wonder.
Peccatula
Record #1 - 984.11.05
...
Record #3 - 984.12.17
- We encountered Peccatula, which can mimic not only the Sinners’ appearances but also their identities and E.G.O. I asked Faust how the Peccatula, which are just things that failed to even Distort, were able to use E.G.O… but Faust shut the entire discussion down by saying that it was still classified information.
...
Stage 3 Pecctatula
Record #1 - 984.12.26
- First encountered at the Wuthering Heights manor, these are entities that have progressed past Stage 2 of their growth.
...
## Story
Dante's Notes has featured three story episodes:
Dante's Notes (Season 1)
Rooms Past The Backdoor (Season 2)
Risk Levels & Classifications (Season 3)
The story cutscenes played automatically when players logged into the game for the first time within a week of the first update.
## Trivia
During the initial release of Dante's Notes, they were written in a different, much less readable font from the current one.
Dante's Notes regarding Lobotomy Corporation mention a "tower-thing" appearing in its place. This is a reference to the Library from *Library of Ruina*.
## References
↑ [ Intro to New Contents - Dante’s Notes ]
## Navigation
*Wiki Navigation
Mechanics**
