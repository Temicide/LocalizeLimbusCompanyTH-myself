...
Charon (Driver)
Vergilius (Guide)
The Sinners (Passengers)
### First Appearance
Prologue: Selva Oscura
### Status
Active
**Mephistopheles** (메피스토펠레스, *me-pi-seu-to-pel-re-seu*) is the bus used by the LCB Team of Limbus Company. Mephistopheles is driven by Charon and is used by the Sinners and Vergilius, serving as their transport, mobile base of operations and habitation in their mission to retrieve the Golden Boughs.
*
## Contents
1 Appearance
2 Abilities
2.1 Enkephalin Extraction
2.2 Extraction
2.3 Regeneration
2.4 Backdoor
2.5 Shapeshifting
...
### Extraction
Using its engine and Lunacy, Mephistopheles can extract random Identities in the form of Identity Cards and E.G.O from Mirror Worlds. Faust describes the engine as using the "concept of possibilities itself" as fuel.
...
Because Mephistopheles' engine changes and adapts with each Golden Bough retrieval, the contents of the Backdoor (namely the Mirror Dungeon) also changes with each retrieval.
...
In Canto IV, Mephistopheles continues traveling through Nest K towards their corporate building.
...
In Canto VI, it delivers the Sinners through T Corp.'s nest to the Wuthering Heights mansion. Its stay is once again delayed when the Sinners are detained for an excessive Time Tax during the events of Intervallo IV: Timekilling Time.
In Intervallo IV: Murder on the WARP Express, Mephistopheles is secured aboard a WARP train bound for P Corp. The Sinners skip the rest of the WARP Train's journey by using the backdoor to reside within the original dimension, disconnected from the train, bypassing the extremely long journey in ten seconds.
In Canto VII, Mephistopheles transports the Sinners to a temporary base in P Corp's Backstreets for the La Manchaland eradication contract.
In Intervallo V: Nocturnal Sweeping, Mephistopheles is driven to District 8. During that time, it is used by the LCC for an assignment, but returns to the Backstreets of District 8 to retrieve the Sinners and transport them to the central zone of H. Corp, kicking off the events of Canto VIII: The Surrendered Witnessing.
Mephistopheles is unavailable during the events of Intervallo VI: Spring Cultivation, forcing the Sinners to navigate Hongyuan themselves.
Mephistopheles is absent for the entirety of Canto IX: The Unsevering, with the Sinners occupying an LCCB Transporter Truck instead.
## Trivia
...
Multiple characters talk about Mephistopheles as if it is a living being. The significance of this anthropomorphic wording, if any, is unknown.
...
In Intervallo II, Faust referred to Mephistopheles' alarm as a "scream", but quickly corrected herself.
...
A gas mask used by Aya, then Yuri (Canto I);
Poker chips stolen by Rodion (Canto II)
The nail an Inquisitor hammered into the windshield (Canto III);
A Bongy plushie (Intervallo I);
A picture of the League of Nine Littérateurs (Canto IV);
A length of Queequeg's rope (Canto V);
A bunch of heath flowers from Wuthering Heights (Canto VI);
The Helm of Mambrino and a map of La Manchaland (Canto VII);
A red and golden kite, which is left resting atop Mephistopheles' roof (Canto VIII).
Mephistopheles is recognized as a residential vehicle, granting it immunity against Sweeper activity.
## Navigation
*Wiki Navigation
**Mechanics**
